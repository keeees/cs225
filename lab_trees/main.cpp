...
int main(int argc, char** argv)
{
    ...
    cout<<myTree.getLeftMost(myTree.getRoot())<<endl;
    cout<<myTree.getRightMost(myTree.getRoot())<<endl;
    cout<<myTree.getLeftMost(myTree.getRoot()->left)<<endl;
    cout<<myTree.getRightMost(myTree.getRoot()->right)<<endl;
